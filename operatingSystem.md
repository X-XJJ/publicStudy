...
- 特征
  ...
  - 异步：
- 功能
  - 管理计算机系统资源：处理器，内存，文件，IO
  - 用户与硬件的接口：命令接口-联机交互式/脱机批处理式，程序接口，UI（本质是程序）接口
  - 计算机扩展
...
- 信号量同步机制-PV操作
  - P = 阻塞原语，申请资源，信号量-1，Proberen（测试，荷兰语）
  - V = 唤醒原语，释放资源，信号量+1，Verhogen（增加，荷兰语）
